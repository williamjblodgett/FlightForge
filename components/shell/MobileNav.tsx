...
export async function MobileNav() {
  ...
  return (
    <nav className="mobile-nav" aria-label="Mobile navigation">
      ...
      <NavLink href="/courses"><Compass aria-hidden="true" /><span>Explore</span></NavLink>
      ...
      <NavLink match="/profile" href={user ? (user.mustChangePassword ? "/account/password" : user.onboardingComplete ? "/profile" : "/onboarding") : "/sign-in"}><UserRound aria-hidden="true" /><span>Profile</span></NavLink>
    </nav>
  );
}
