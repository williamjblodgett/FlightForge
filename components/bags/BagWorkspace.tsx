...
type Props = {
  roundContext?: RoundAssistance | null;
...
export function BagWorkspace({ initialDiscs, catalog, controlledDistanceFeet, throwingHand, caddieEnabled, roundContext }: Props) {
  ...
  const [caddie, setCaddie] = useState<CaddieState>({ distanceFeet: "", windMph: "", windDirection: "CALM", fairwayShape: "STRAIGHT", throwType: "BACKHAND", riskPreference: "BALANCED", elevationChangeFeet: "", groundCondition: "NORMAL", hazardLevel: "MODERATE" });
