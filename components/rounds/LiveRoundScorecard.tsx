  ...
  return <div className="live-round-shell">
    ...
    <header className="round-hud" aria-label="Active round controls">
      ...
      <div className="round-hud-actions">
        <Link href="/bag#caddie-chat" aria-label="Ask the caddie"><Sparkles aria-hidden="true" /></Link>
        <Link className="hud-secondary" href={`/community?context=event&id=${encodeURIComponent(eventId)}`} aria-label="Open event community chat"><MessageCircle aria-hidden="true" /></Link>
