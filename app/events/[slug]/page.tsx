...
export default async function EventDetailPage({ params }: Props) {
  ...
  const scorecardHref = `/play?${new URLSearchParams({ eventId: event.id, courseId: event.courseId ?? `event-${event.id}`, eventTitle: event.title, courseName: event.venueName }).toString()}`;
