...
export const metadata: Metadata = { title: "Link hosted identity", robots: { index: false, follow: false } };
...
export default async function AccountLinkPage() {
  ...
  return <main className="auth-page page-shell"><div className="auth-heading"><span className="eyebrow">Account protection</span><h1>Confirm before linking.</h1><p>A hosted identity has the same email as an existing FlightForge password account. Email matching alone is never enough to merge them.</p></div><HostedAccountLinkForm email={user.email} /></main>;
}
